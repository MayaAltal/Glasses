                                                    ...
                                                    <tr>
                                                       ...
                                                       <td><?php echo e($book->phoneNumber); ?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="/AddFatora/<?php echo e($book->id); ?>" class="btn btn-soft-dark" type="submit">
                                                                انشاء فاتورة
                                                            </a>
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-3">
                                                                ...
                                                                <a href="/showfatora/<?php echo e($book->id); ?>" class="btn btn-soft-danger" type="submit">
                                                                    عرض التفاصيل
                                                                </a>
...
<?php echo $__env->make('userheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Glasses\resources\views/Show-hotel-reservation.blade.php ENDPATH**/ ?>